...
class Vehicle:
	...
	MAP_VEHICLE_TYPE = {
	VEHICLE_TYPE_PASSENGER:VehicleType(VEHICLE_TYPE_PASSENGER, 0.8, 4.5, 0.5, VEHICLE_TYPE_PASSENGER_COLOR, 5, 2.5, 16.67, VEHICLE_TYPE_PASSENGER),
	VEHICLE_TYPE_TRANSPORT:VehicleType(VEHICLE_TYPE_TRANSPORT, 0.8, 4.5, 0.5 ,VEHICLE_TYPE_TRANSPORT_COLOR, 10, 3, 25, VEHICLE_TYPE_TRANSPORT),
	VEHICLE_TYPE_BUS:VehicleType(VEHICLE_TYPE_BUS, 0.8, 4.5, 0.5, VEHICLE_TYPE_BUS_COLOR, 10, 3, 25, VEHICLE_TYPE_BUS),
	VEHICLE_TYPE_EMERGENCY:VehicleType(VEHICLE_TYPE_EMERGENCY, 1, 5.5 , 0.7, VEHICLE_TYPE_EMERGENCY_COLOR, 7, 2.5, 30, "passenger/van")
