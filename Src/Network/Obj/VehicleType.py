...
class VehicleType:
	...
	def __init__(self, iId, iAccel, iDecel, iSigma = 0.5, iColor = None, iLength = None, iMinGap = None, iMaxSpeed = None, iGuiShape = None, iCarFollow = None, iTau = None, iSpeedFactor = None, iSpeedDev = None, iVClass = None, iEmissionClass = None, iWidth = None, iImgFile = None):
		self.mId = iId
		self.mCarFollow = self.setCarFollow(iCarFollow)
		if self.mCarFollow is None:
			self.mAccel = iAccel
			self.mDecel = iDecel
			self.mSigma = iSigma
			self.mTau = iTau
